...
public class MyAssert {
    ...
    public static void assertEqualsAfterSorted(List<? extends Object> expected, List<? extends Object> actual) {
        Assert.assertEquals(Converter.listToSortedString(expected), Converter.listToSortedString(actual));
    }
